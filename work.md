...
- [x] Static-link regression check: `scripts/check_static_link.py` +
      `just static-link-check` (native) and `scripts/verify_linux.sh` +
      `just verify-linux` (Linux via Docker), wired into `test.yml`; a green CI
